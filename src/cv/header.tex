...
\name{Hervé}{Nivon}
\position{CTO{\enskip\cdotp\enskip}Business Angel{\enskip\cdotp\enskip}Computer Science Engineer{\enskip\cdotp\enskip}Solutions Architect{\enskip\cdotp\enskip}Talent Developer}
